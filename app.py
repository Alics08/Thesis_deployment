...
class YourChatbotClass:
    ...
    def get_response(self, predicted_intent, confidence, sentence):
        if confidence > self.threshold:
            ...
            return "I'm sorry, thats beyond on my trained knowledge. Can you please provide more information or rephrase your question?"
        else:
            ...
            return "I'm sorry, thats beyond on my trained knowledge. Could you please rephrase or be more specific?"
